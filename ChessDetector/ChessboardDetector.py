...
class ChessboardDetector:
    def __init__(self, image_path, squares_per_row=8):
        """
    ...
    def identify_pieces(self, cropped_sections, black, white):
        ...
        if cropped_sections and black is not None and white is not None:
            ...
            square_size = canvas_size // self._squares_per_row
            ...
            for i, section in enumerate(cropped_sections):
                ...
                row = i // self._squares_per_row  # Calculate the row index
                col = i % self._squares_per_row  # Calculate the column index
